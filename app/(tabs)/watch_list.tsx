...
export default function WatchListScreen() {
  ...
  const [activeCategory, setActiveCategory] = useState<WatchlistCategory>('Movie');
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        <ThemedText style={styles.title}>Watch List</ThemedText>
        <TouchableOpacity
      ...
      {activeCategory === 'Movie' && (
        <>
          {watchlistLoading && watchlistMovies.length === 0 ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <ThemedText style={styles.emptyText}>
                Start adding movies to your watchlist by tapping the bookmark icon on any movie card.
              </ThemedText>
            </View>
          ) : (
            <MovieGrid
